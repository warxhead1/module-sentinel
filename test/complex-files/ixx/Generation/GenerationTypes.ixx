...
export module GenerationTypes;

import NoiseTypes;
import GLMModule;

using namespace PlanetGen::Rendering::Noise;

// Forward declarations - WaterRenderer moved to avoid module conflicts

// Export planetary types at module level for easy access
export namespace PlanetGen::Generation {
    ...
    /**
     * Noise data packet for GPU processing pipelines
     * Note: This is different from Physics::NoisePacket which is for erosion
     */
    struct NoiseDataPacket {
...
/**
 * @brief Texture resource for pipeline rendering
 */
